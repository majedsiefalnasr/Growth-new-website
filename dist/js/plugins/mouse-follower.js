export var mouse_followe_init = function () {
  !(function (t, e) {
        ...
        (e.bind = function () {
          ...
          (this.event.mouseleave = function () {
            ...
            (this.event.mouseover = function (e) {
              for (
                var i = e.target;
                i && i !== t.container && (!e.relatedTarget || !i.contains(e.relatedTarget));
                i = i.parentNode
              ) {
            ...
            this.options.hideOnLeave &&
              this.container.addEventListener('mouseleave', this.event.mouseleave, { passive: !0 }),
            this.options.visible &&
              this.container.addEventListener('mouseenter', this.event.mouseenter, { passive: !0 }),
            ...
            (this.options.stateDetection || this.options.dataAttr) &&
              (this.container.addEventListener('mouseover', this.event.mouseover, { passive: !0 }),
              this.container.addEventListener('mouseout', this.event.mouseout, { passive: !0 }));
        }),
        (e.render = function (t) {
          if (!0 === t || (0 !== this.vel.y && 0 !== this.vel.x)) {
            if (
              ...
              var e = Math.sqrt(Math.pow(this.vel.x, 2) + Math.pow(this.vel.y, 2)),
                i =
                  Math.min(e * this.options.skewingDelta, this.options.skewingDeltaMax) *
                  this.skewing,
